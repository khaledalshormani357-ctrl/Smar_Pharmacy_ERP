                          ...
                          {!isFullyReturned ? (
                            <div className="flex items-center gap-1">
                              ...
                              <input
                                ...
                                className="w-16 px-2 py-1 text-center font-bold text-xs bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                              />
                            </div>
                          ) : (
